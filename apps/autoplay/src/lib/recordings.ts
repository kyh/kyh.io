...
// into a single stream. Retention is by age: a day of stream at the station's
// cap is under a gigabyte, so a few hours is plenty and keeps the store from
// growing without bound.

/** How far back a replay reaches; older chunks and their files are dropped. */
const RETENTION_MS = 6 * 3_600_000;
/** How many sessions a replay is handed at once. */
const REPLAY_SESSIONS = 6;
...
/**
 * Keep a chunk, and let go of the ones that have aged out — files first,
