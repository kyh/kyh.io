...
import { CompModal } from "@/components/comp-modal";
import { FormField } from "@/components/form-field";
import { useModal } from "@/components/modal";
import { currencyInputFormatProps, staticInputFormatProps } from "@/lib/form-props";
import { cn } from "cn";
...
const shareCalcTypeLabels = {
  current: "Growth Based",
...
export const CompForm = ({ comp }: Props) => {
  ...
  useEffect(() => {
    if (appliedRequest.current === updateRequest) {
      return;
    }
            ...
            >
              <div className="relative">
                <Listbox.Button className="text-emerald-500">
                  {shareCalcTypeLabels[comp.shareCalcType]}
                </Listbox.Button>
