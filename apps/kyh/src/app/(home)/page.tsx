    ...
    <div className="relative z-10 mx-auto flex w-full flex-col gap-10 sm:w-[560px]">
      ...
      <Section id="other-activities" delay={0.9}>
        ...
        <p className="text-foreground mt-1">
          ...
          occasionally find me dabbling in the open source world, drawing things, building apps, and
          designing games. But honestly, I spend most of my days procrastinating.
        </p>
      </Section>
