...
const styles = stylex.create({
  ...
  size3: { width: spacing[3], height: spacing[3] },
  size3_5: { width: spacing[3.5], height: spacing[3.5] },
  /** colour comes from the hovered `.group` ancestor; see global.css */
  groupIcon: { color: "var(--group-icon-color, var(--body-color-faded))" },
});
export const Logo = () => (
  <svg viewBox="0 0 1026 1026" {...stylex.props(styles.size8)} aria-hidden="true">
    <g fill="none" fillRule="evenodd">
      <rect width="1026" height="1026" fill="currentColor" rx="100" />
      <g fill="var(--bg-highlighted)" transform="translate(272 257)">
        <path
          d="M92.9744377,159.271472 C92.6010464,158.283742 71.4422051,121.984663 46.1760594,78.7714724 L-2.27373675e-13,0 L-2.27373675e-13,80.5 L-2.27373675e-13,161 L46.7983783,161 C87.0001766,161 93.4722928,160.753067 92.9744377,159.271472 Z"
          transform="matrix(1 0 0 -1 0 161)"
        />
        <path
          d="M263.079239,511.628986 C263.079239,511.381643 229.969327,453.750725 189.570293,383.505314 L116.061346,255.752657 L172.026981,158.54686 L227.992616,61.2173913 L302.984095,60.8463768 L377.852031,60.5990338 L357.714286,95.4743961 C346.71883,114.76715 321.392218,158.670531 301.625107,193.051208 L265.550128,255.752657 L339.306163,383.876329 L413.062198,512 L447.407555,512 L481.876456,512 L480.393922,509.279227 C479.529111,507.671498 446.419199,450.04058 406.761431,381.155556 L334.611474,255.752657 L405.89662,131.957488 C445.06021,63.8144928 478.170122,6.18357488 479.529111,4.08115942 L482,0 L338.070719,0 L194.141437,0 L120.508946,127.876329 L47,255.752657 L120.756035,383.876329 L194.388526,512 L228.733882,512 C247.636183,512 263.079239,511.876329 263.079239,511.628986 Z"
          transform="matrix(1 0 0 -1 0 512)"
        />
        <path
          d="M92.9744377,352.728528 C93.4722928,351.246933 87.0001766,351 46.7983783,351 L-2.27373675e-13,351 L-2.27373675e-13,431.5 L-2.27373675e-13,512 L46.1760594,433.228528 C71.4422051,390.015337 92.6010464,353.716258 92.9744377,352.728528 Z"
          transform="matrix(1 0 0 -1 0 863)"
        />
      </g>
    </g>
  </svg>
...
export const ArrowUpRight = () => (
  <svg
    ...
    fill="currentColor"
    viewBox="0 0 256 256"
    {...stylex.props(styles.size3, styles.groupIcon)}
    aria-hidden="true"
  >
...
export const GitHubIcon = () => (
  <svg viewBox="0 0 32 32" fill="currentColor" {...stylex.props(styles.size4)} aria-hidden="true">
...
export const TwitterIcon = () => (
  <svg viewBox="0 0 39 32" fill="currentColor" {...stylex.props(styles.size4)} aria-hidden="true">
...
export const LinkedInIcon = () => (
  <svg viewBox="0 0 17 17" fill="currentColor" {...stylex.props(styles.size4)} aria-hidden="true">
